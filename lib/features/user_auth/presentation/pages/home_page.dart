...
class HomeScreen extends StatelessWidget {
  ...
  HomeScreen({required this.user, required String userName, required int points});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: AppDrawer(user: user), // Add the drawer here
      body: Stack(
        children: [
          Center(
            child: Column(
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => PointScreen(isAdmin: isAdmin),
                      ),
                    );
                  },
                  child: Row(
